                  ...
                  <div className="header_search_content">
                    <div className="header_search_form_container">
                      <form onSubmit={this.handleFormSubmit} className="header_search_form clearfix">
                        ...
                        <input type="text" required="required" className="header_search_input" type='email' placeholder='please input' value={this.state.email} onChange={this.handleEmailChange}  />
